...
module Reinterpret = struct
  module Uint8 = struct
    ...
    external ba_of_ta : uint8_ta -> uint8_ba = "ft_owljs_uint8_ba_of_ta"

    external ta_of_ba : uint8_ba -> uint8_ta = "ft_owljs_uint8_ta_of_ba"
  end

  module Float32 = struct
    external ba_of_ta : float32_ta -> float32_ba = "ft_owljs_float32_ba_of_ta"

    external ta_of_ba : float32_ba -> float32_ta = "ft_owljs_float32_ta_of_ba"
  end
end
