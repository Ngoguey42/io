...
function ft_js_int32_ta_of_ba(arr) {
  if (!(arr.kind == 0 || arr.kind == 10))
    console.log("Pas bien 51", arr)
  if (!(arr.data instanceof Int32Array))
    console.log("Pas bien 52", arr)
  return arr.data
}
...
function ft_js_create_component_type(ftJsConstructor){
  ...
  FtJsComponent.prototype = Object.create(React.Component.prototype)
